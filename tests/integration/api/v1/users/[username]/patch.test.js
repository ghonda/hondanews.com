...
describe("PATCH /api/v1/users/[username]", () => {
    describe("Default users", () => {
        ...
        test("userB targeting userA", async () => {
        ...
        test("duplicate username should return 400", async () => {
            await orchestrator.createUser({
                username: "user1",
            });
        ...
        test("unique username should return 200", async () => {
        ...
        test("unique email should return 200", async () => {
            const createdUser = await orchestrator.createUser({
        ...
        test("new password should return 200", async () => {
            const createdUser = await orchestrator.createUser({
